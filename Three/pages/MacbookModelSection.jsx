  ...
  useGSAP(
    () => {
      ...
      if (solarModelRef) {
        ...
        gsap.set(solarModelRef.position, { y: 150, x: 50, z: 10 });
    ...
    >
      <div ref={canvasRef} className="w-full h-full absolute z-20 inset-0">
        ...
        >
          ...
          <MacModel onModelReady={setSolarModelRef} />
        </Canvas>
      </div>
      <h2
        ref={titleRef}
      ...
      >
        ...
        Schnell Energy's{" "}
        <span className="text-[#94bbf3] font-bold"> SMART technology</span> is a
        self-learning platform that continuously adapts to your energy
        consumption patterns. By{" "}
        <span className="text-[#94bbf3] font-bold">
          utilizing AI and machine learning algorithms
        </span>
        , SMART helps to identify areas for improvement and proactively adjusts
...
export default MacbookModelSection;
